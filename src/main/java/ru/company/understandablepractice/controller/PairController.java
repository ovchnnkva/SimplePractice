...
public class PairController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<PairResponse> getById(@PathVariable @Parameter(description = "ID пары") long id) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> delete(@PathVariable @Parameter(description = "ID пары") long id) {
