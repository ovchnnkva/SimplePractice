...
public class CalendarController {
    ...
    public CalendarResponse getCalendar(@PathVariable @Parameter(name = "ID Пользователя") long userId,
                                        @PathVariable @Parameter(name = "Год, в рамках которого находятся встречи") String year) {
